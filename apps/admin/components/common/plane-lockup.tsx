 ...
 * Admin has no dependency on the @plane/propel workspace package (only on
 * @makeplane/propel from npm, which ships no lockup), so this is a local copy
 * kept identical to propel's src/icons/brand/plane-lockup.tsx. Change both.
 */
