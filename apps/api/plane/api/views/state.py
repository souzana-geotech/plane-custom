...
class StateDetailAPIEndpoint(BaseAPIView):
    ...
    @state_docs(
        ...
        description="Permanently remove a workflow state from a project. Default states and states with existing tasks cannot be deleted.",  # noqa: E501
        parameters=[
            STATE_ID_PARAMETER,
        ],
        responses={
    ...
    def delete(self, request, slug, project_id, state_id):
        ...
        Default states and states with existing tasks cannot be deleted.
        """
