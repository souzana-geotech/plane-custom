    ...
    <div className="mt-10">
      ...
      <div className="rounded-lg border border-subtle bg-layer-2">
        ...
        <SettingsBoxedControlItem
          ...
          title={t("archive")}
          description="Archiving a container will unlist your container from your side navigation although you will still be able to access it from your containers page. You can restore the container or delete it whenever you want."
          control={
        ...
        <SettingsBoxedControlItem
          ...
          title={t("delete")}
          description="When deleting a container, all of the data and resources within that container will be permanently removed and cannot be recovered."
          control={
