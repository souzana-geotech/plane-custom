...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The task is the building block of Geotech3D. Most concepts in Geotech3D are either associated with tasks and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
  ...
  {
    key: "modules",
    title: "Break into projects / jobs",
    description: "Projects / Jobs break your big thing into Containers or Features, to help you organize better.",
    image: ModulesTour,
    prevStep: "cycles",
    nextStep: "views",
  },
          ...
          <div className="h-full overflow-hidden">
            ...
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Welcome to Geotech3D, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                We{"'"}re glad that you decided to try out Geotech3D. You can now manage your projects with ease. Get
