...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Zendesk",
        description: "Create Plane tasks from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create Plane tasks from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
