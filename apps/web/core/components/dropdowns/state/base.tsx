  ...
  return (
    ...
    >
      {isOpen && (
        <Combobox.Options
          as="ul"
          // the popper ref has to live here: headlessui v2 wraps Combobox.Options' single
          // child in <Frozen>, which clones it with its own ref and drops any ref set on it
