...
export const SITE_DESCRIPTION =
  "Open-source project management tool to manage tasks, cycles, and product roadmaps easily";
export const SITE_KEYWORDS =
  "software development, plan, ship, software, accelerate, code management, release management, project management, tasks tracking, agile, scrum, kanban, collaboration";
