...
// Enabled for live dependency auto-shift on the gantt: gantt fetches include
// `issue_relation`/`issue_related`, which populates the relation map the
// in-browser shift engine walks.
